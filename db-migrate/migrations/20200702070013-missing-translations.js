...
exports.up = async function (db) {
  ...
  const translationsData = [
    { language: language, key: "wildduck account", value: "WildDuck Account", status: status },
    { language: language, key: "wildduck email", value: "WildDuck Email", status: status },
    { language: language, key: "wildduck password", value: "WildDuck Password", status: status },
