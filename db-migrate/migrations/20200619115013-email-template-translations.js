...
exports.up = async function (db) {
  ...
  const translationsData = [
    { language: language, key: "invoice reminder email", value: "Invoice Reminder Email", status: status },
    { language: language, key: "invoice email with pdf", value: "Invoice Email with PDF", status: status },
    { language: language, key: "email body", value: "Email Body", status: status },
  ];
