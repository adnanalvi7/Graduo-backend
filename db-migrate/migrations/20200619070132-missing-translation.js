...
exports.up = async function (db) {
  ...
  const translationsData = [
    ...
    { language: language, key: "Viernes", value: "Viernes", status: status },
    { language: language, key: "update password", value: "update password", status: status },
    { language: language, key: "change password", value: "change password", status: status },
