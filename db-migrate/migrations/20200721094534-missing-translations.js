...
exports.up = async function (db) {
  ...
  const translationsData = [
    { language: language, key: "name English", value: "Name English", status: status },
    { language: language, key: "name Spanish", value: "Name Spanish", status: status },
    { language: language, key: "name Catalan", value: "Name Catalan", status: status },
