...
exports.up = async function (db) {
  ...
  const translationsData = [
    { language: language, key: "send invoice by email to", value: "Send invoice by email to", status: status },
    { language: language, key: "send reminder email to", value: "Send reminder email to", status: status },
  ];
