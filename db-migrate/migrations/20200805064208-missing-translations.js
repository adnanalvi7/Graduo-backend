...
exports.up = async function (db) {
  ...
  const translationsData = [
    { language: language, key: "quote number", value: "Quote Number", status: status },
    { language: language, key: "quote date", value: "Quote Date", status: status },
    { language: language, key: "total quote", value: "Total Quote", status: status },
    { language: language, key: "quote concepts", value: "Quote Details", status: status },
  ];
